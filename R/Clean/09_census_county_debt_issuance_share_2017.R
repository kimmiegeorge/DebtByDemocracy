...
# Non-city debt covers county, special-district, and school-district
# governments. Reuse the county policy flags and BEA controls from the county
...
table_call <- etable(
  r1_2017_county_share,
  r3_2017_county_share,
  coefstat = 'tstat',
  drop = 'Constant',
  style.tex = style.tex(
    main = 'aer',
