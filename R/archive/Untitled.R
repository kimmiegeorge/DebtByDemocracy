...
reg2 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim ==1])
reg3 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               state_godebt_limit + state_ltgo_allowed +state_fullfaith + state_sep_debtservice_levy + state_sep_pledgerev + state_statutorylien|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim ==1])
reg4 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               ...
               ln_gdp + ln_emp + ln_percap_inc + ln_pers_inc|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim == 1])
...
reg2 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[rev == 0])
reg3 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
...
reg2 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim == 1 & category != 'green'])
reg3 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               state_godebt_limit + state_ltgo_allowed +state_fullfaith + state_sep_debtservice_levy + state_sep_pledgerev + state_statutorylien|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim == 1 & category != 'green'])
reg4 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               state_godebt_limit + state_ltgo_allowed +state_fullfaith + state_sep_debtservice_levy + state_sep_pledgerev + state_statutorylien +
               ln_gdp + ln_emp + ln_percap_inc + ln_pers_inc|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[go_unlim == 1 & category != 'green'])
...
reg2 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[rev == 0  & category != 'green'])
reg3 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               state_godebt_limit + state_ltgo_allowed +state_fullfaith + state_sep_debtservice_levy + state_sep_pledgerev + state_statutorylien|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[rev == 0  & category != 'green'])
reg4 <- felm(offering_yield_tr ~ city_go_vote + ln_amount + ln_maturity + callable  + sinkable + insured + rated + 
               state_godebt_limit + state_ltgo_allowed +state_fullfaith + state_sep_debtservice_levy + state_sep_pledgerev + state_statutorylien +
               ln_gdp + ln_emp + ln_percap_inc + ln_pers_inc|yrmonth + group + use_proceeds|0|seed_issuer_id, data = data[rev == 0  & category != 'green'])
...
reg2 <- felm(issuance_month_total_articles ~ city_go_vote + ln_amount + ln_gdp + ln_pers_inc + ln_percap_inc + ln_employment|year + group + use_proceeds|0|seed_issuer_id, data = issuance_lvl[go_unlim_bond_issuance == 1])
...
reg4 <- felm(total_rp_articles_6mo_window_event ~ city_go_vote + ln_amount + ln_gdp + ln_pers_inc + ln_percap_inc + ln_employment|year + group + use_proceeds|0|seed_issuer_id, data = issuance_lvl[go_unlim_bond_issuance == 1])
...
reg2 <- felm(issuance_month_total_articles ~ city_go_vote + ln_amount + ln_gdp + ln_pers_inc + ln_percap_inc + ln_employment|year + group + use_proceeds|0|seed_issuer_id, data = issuance_lvl[rev_bond_issuance == 0 & category != 'green'])
...
reg4 <- felm(total_rp_articles_6mo_window_event ~ city_go_vote + ln_amount + ln_gdp + ln_pers_inc + ln_percap_inc + ln_employment|year + group + use_proceeds|0|seed_issuer_id, data = issuance_lvl[rev_bond_issuance == 0 & category != 'green'])
