...
data[, school_adj := grepl('BRD ED',issuer_long_name )]
data[, city := ifelse(school_adj == 1, 0, city)]
data <- data[city == 1]
...
go_all <- ggplot(all_go_bonds, aes(x = "", y = Bonds, fill = Category, label = paste0(round(percentage), "%"))) +                  
  ...
  geom_text(position = position_stack(vjust = 0.5), color = 'white', fontface = 'bold') +                                                                     
  coord_polar("y") +                                                                                                      
  labs(title = "Panel C: Unlim. Tax and Lim. Tax GO Vote (N = 75,513 Bonds)") + theme_void()  + scale_fill_grey(start = 0.3, end = 0.8)  + 
  theme(                                                                                                                  
...
go_unlim <- ggplot(go_unlim_only, aes(x = "", y = Bonds, fill = Category, label = paste0(round(percentage), "%"))) +                  
  ...
  geom_text(position = position_stack(vjust = 0.5), color = 'white', fontface = 'bold') +                                                                     
  coord_polar("y") +                                                                                                      
  labs(title = "Panel B: Unlim. Tax GO Vote (N = 30,379 Bonds)") + theme_void()  + scale_fill_grey(start = 0.3, end = 0.8)  + 
  theme(                                                                                                                  
    plot.title = element_text(family = "Times New Roman", hjust = 0.5), 
    legend.text = element_text(size = 12)
  )       
...
no_vote <- ggplot(no_vote_bonds, aes(x = "", y = Bonds, fill = Category, label = paste0(round(percentage), "%"))) +                  
  ...
  geom_text(position = position_stack(vjust = 0.5), color = 'white', fontface = 'bold') +                                                                     
  coord_polar("y") +                                                                                                      
  labs(title = "Panel A: No Vote (N = 72,555 Bonds)") + theme_void()  + scale_fill_grey(start = 0.3, end = 0.8)  + 
  theme(                                                                                                                  
    plot.title = element_text(family = "Times New Roman", hjust = 0.5), 
    legend.text = element_text(size = 12)
  )     
