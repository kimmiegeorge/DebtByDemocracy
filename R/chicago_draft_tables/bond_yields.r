...
issuance_lvl_merge <- issuance_lvl[, .(seed_issuer_id, year, month, unique_sources_12, 
                                       total_rp_articles_12_0, rolling_sum_monthly_article_count_12)]
...
for_merge <- unique(full_data[, .(seed_issuer_id, ym, unique_sources_12,
                                  total_rp_articles_12_0, high_articles_12_0, rolling_sum_monthly_article_count_12)])
...
#border_full_data <- border_full_data[!(group %in% c('Missouri/Kentucky', 'Missouri/Tennessee', 'Rhode Island/Massachusetts'))]
...
desc <- full_data[rolling_sum_monthly_article_count_12 > 0, .(offering_yield_tr, 
                   offering_yield_spread_tr,
                 city_go_vote, high_articles_12_0, 
                 maturity_mths_tr, callable, sinkable, insured, rated)]
...
desc_col[, variable := c('Yield', 'Yield Spread', 'Vote', 'I(Media Coverage - 12mo)', 'Maturity', 'Callable', 'Sinkable', 'Insured', 'Rated')]
...
r1 <- feols(offering_yield ~ city_go_vote*high_articles_12_0  + maturity_mths + callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp + glm_proactive + state_ltgo_allowed + state_go_vote + glm_proactive + state_ltgo_allowed |ym + purp_broad + amount_quintile, data = full_data[rolling_sum_monthly_article_count_12 > 0 & state != 'RI'], vcov = vcov_cluster(~issue_id))
summary(r1)
r2 <- feols(offering_yield_spread ~ city_go_vote*high_articles_12_0 + city_rev_vote + maturity_mths +  callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp + state_go_vote  + glm_proactive + state_ltgo_allowed  |ym + purp_broad + amount_quintile, data = full_data[rolling_sum_monthly_article_count_12 > 0], vcov = vcov_cluster(~issue_id))
summary(r2)
r3 <- feols(offering_yield ~ city_go_vote*high_articles_12_0  + city_rev_vote + maturity_mths + callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp  + state_go_vote |group + ym + purp_broad + amount_quintile, data = border_full_data[rolling_sum_monthly_article_count_12 > 0], vcov = vcov_cluster(~issue_id))
summary(r3)
r4 <- feols(offering_yield_spread ~ city_go_vote*high_articles_12_0 + city_rev_vote + maturity_mths  + 
              callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  
              ln_pers_inc  + ln_emp  + state_go_vote |group + ym + purp_broad + amount_quintile, 
            data = border_full_data[rolling_sum_monthly_article_count_12 > 0], vcov = vcov_cluster(~issue_id))
summary(r4)
...
writeLines(modified_output, paste0(tbl_dir, '/bond_yields_restricted.tex'))
...
r1 <- feols(offering_yield_spread_tr ~ city_go_vote  + city_rev_vote + maturity_mths_tr + callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + 
              ln_emp + glm_proactive + state_ltgo_allowed + state_go_vote + glm_proactive + 
              state_ltgo_allowed |ym + purp_broad + amount_quintile, data = full_data[rolling_sum_monthly_article_count_12 > 0 & high_articles_12_0 == 0], vcov = vcov_cluster(~issue_id))
summary(r1)
...
r3 <- feols(offering_yield_spread_tr ~ city_go_vote  + city_rev_vote + maturity_mths_tr + callable  + sinkable + insured + rated + unique_sources_12 + 
              ln_gdp + ln_pop +  ln_pers_inc  + ln_emp + glm_proactive + state_ltgo_allowed + state_go_vote + glm_proactive + state_ltgo_allowed |purp_broad + amount_quintile + group + year, data = border_full_data[rolling_sum_monthly_article_count_12 > 0 & high_articles_12_0 == 0 ], vcov = vcov_cluster(~issue_id))
summary(r3)
...
r1 <- feols(offering_yield ~ city_go_vote  + maturity_mths + callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp + glm_proactive + state_ltgo_allowed + state_go_vote + glm_proactive + state_ltgo_allowed |ym + purp_broad + amount_quintile, data = full_data, vcov = vcov_cluster(~issue_id))
summary(r1)
r2 <- feols(offering_yield_spread ~ city_go_vote + city_rev_vote + maturity_mths +  callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp + state_go_vote  + glm_proactive + state_ltgo_allowed  |ym + purp_broad + amount_quintile, data = full_data, vcov = vcov_cluster(~issue_id))
summary(r2)
r3 <- feols(offering_yield ~ city_go_vote  + city_rev_vote + maturity_mths + callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  ln_pers_inc  + ln_emp  + state_go_vote |group + ym + purp_broad + amount_quintile, data = border_full_data, vcov = vcov_cluster(~issue_id))
summary(r3)
r4 <- feols(offering_yield_spread ~ city_go_vote + city_rev_vote + maturity_mths  + 
              callable  + sinkable + insured + rated + unique_sources_12 + ln_gdp + ln_pop +  
              ln_pers_inc  + ln_emp  + state_go_vote |group + ym + purp_broad + amount_quintile, 
            data = border_full_data, vcov = vcov_cluster(~issue_id))
summary(r4)
