...
OUT_DIR = DATA_DIR / 'Mergent' / 'Outstanding Debt'
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_DATE = '260709'

BOND_FILE = MERGENT_DIR / '260707_city_cusiplevel_statereq_purpose_yieldspread.dta'
ISSUER_FILE = MERGENT_DIR / '260707_city_issuerlevel_yieldspread.dta'
BEA_COUNTY_DEMOS_FILE = BEA_DIR / 'countydemos_1999_2026.dta'

ISSUER_YEAR_PANEL = OUT_DIR / f'{OUTPUT_DATE}_issuer_year_outstanding_debt.csv'
ANNUAL_SUMMARY = OUT_DIR / f'{OUTPUT_DATE}_annual_outstanding_debt_by_vote_status.csv'
POOLED_REGRESSIONS = OUT_DIR / f'{OUTPUT_DATE}_pooled_outstanding_debt_year_fe_regressions.csv'
DIAGNOSTICS = OUT_DIR / f'{OUTPUT_DATE}_outstanding_debt_build_diagnostics.csv'
