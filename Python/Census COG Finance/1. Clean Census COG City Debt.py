...
processed_dir = census_dir / 'processed'
diagnostics_dir = census_dir / 'diagnostics'

processed_dir.mkdir(parents=True, exist_ok=True)
diagnostics_dir.mkdir(parents=True, exist_ok=True)

mergent_bond_file = data_dir / 'Mergent' / 'Clean' / '260709_city_cusiplevel_statereq_purpose_yieldspread.dta'
