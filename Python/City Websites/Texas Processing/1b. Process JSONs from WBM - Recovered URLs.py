...
input_dir = os.path.expanduser(
    '~/Dropbox/Voting on Bonds/Data/Websites/Texas/WBM/Recovered URLs From Bad URLs Investigation')

# Output directory: new subdirectory for processed recovered URLs
output_dir = os.path.expanduser(
    '~/Dropbox/Voting on Bonds/Data/Websites/Texas/WBM/Recovered URLs From Bad URLs Investigation/Processed')
...
def run_json_processing_for_year(year):
    ...
    sample_issuers = pl.read_csv(
        '/Users/kmunevar/Dropbox/Voting on Bonds/Data/Websites/Texas/City Website Collection.csv')
