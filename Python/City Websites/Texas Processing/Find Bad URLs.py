...
import polars as pl
import os
input_dir = os.path.expanduser('~/Dropbox/Voting on Bonds/Data/Websites/Texas/WBM/Processed')
...
# output
bad_url.write_csv('~/Dropbox/Voting on Bonds/Data/Websites/Texas/Collection Files/bad_urls_251113.csv')