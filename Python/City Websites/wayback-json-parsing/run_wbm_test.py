...
def wayback_query(host, match_type="exact", collapse_time=10) -> pd.DataFrame | None:
    # Wayback API query
    q = "https://1m3m6w7bs8.execute-api.us-west-1.amazonaws.com/fireprox/cdx/search/cdx?url={}&matchType={}&collapse=timestamp:{}&output=json".format(
    ...
    # If matches returned
        ...
        df["url"] = [
            "https://1m3m6w7bs8.execute-api.us-west-1.amazonaws.com/fireprox/web" + "/" + t + "/" + o
...
def wayback_urlparse(url):
    ...
    if re.search("https://1m3m6w7bs8.execute-api.us-west-1.amazonaws.com/fireprox/web/[0-9]{14}/", url):
        timestamp = re.search("[0-9]{14}", url)[0]
        original = re.sub("https://1m3m6w7bs8.execute-api.us-west-1.amazonaws.com/fireprox/web/[0-9]{14}/", "", url)
...
if __name__ == "__main__":
    url = 'www.quincy-mi.org'
    WaybackScraper(host=url, freq='Y', date_range=('2022-01-01', '2022-12-31'), path = f'{PATH}Annual Files/')
