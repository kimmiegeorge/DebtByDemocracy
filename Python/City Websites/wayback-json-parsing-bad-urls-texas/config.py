"""
Configuration for Bad URLs Recovery Pipeline - Texas
"""
...
class PathConfig:
    ...
    # Input: bad URLs CSV
    bad_urls_file: str = "~/Dropbox/Voting on Bonds/Data/Websites/Texas/Collection Files/bad_urls_251113.csv"
    
    # Original scraping output directory
    base_path: str = "~/Dropbox/Voting on Bonds/Data/Websites/Texas/WBM/"
    
    # Collection files directory
    collection_files_path: str = "~/Dropbox/Voting on Bonds/Data/Websites/Texas/Collection Files/"
    
    # Output directory for recovery results
    recovery_output_path: str = "~/Dropbox/Voting on Bonds/Data/Websites/Texas/WBM/Recovery 202511/"
