...
output_date = '260605'
output_dir = dpc_news_dir / 'OpenAI Bond Election Classification'
output_dir.mkdir(parents=True, exist_ok=True)

candidate_csv = output_dir / f'DPC_Bond_Election_Candidate_Articles_{output_date}.csv'
batch_input_jsonl = output_dir / f'DPC_Bond_Election_OpenAI_Batch_Input_{output_date}.jsonl'
batch_metadata_json = output_dir / f'DPC_Bond_Election_OpenAI_Batch_Metadata_{output_date}.json'
batch_output_jsonl = output_dir / f'DPC_Bond_Election_OpenAI_Batch_Output_{output_date}.jsonl'
classification_csv = output_dir / f'DPC_Bond_Election_OpenAI_Classifications_{output_date}.csv'
...
def split_jsonl(args: argparse.Namespace) -> None:
    ...
    def flush_chunk() -> None:
        ...
        if not current_lines:
            return
        chunk_path = chunk_dir / f'DPC_Bond_Election_OpenAI_Batch_Input_{output_date}_part{chunk_index:03d}.jsonl'
