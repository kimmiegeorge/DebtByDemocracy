...
os.makedirs(f'{clean_data_dir}/TX/News', exist_ok=True)
...
rp_map = pl.read_csv(f'{clean_data_dir}/News/RP_Mergent_Mapping.csv')
...
rp_cities_with_coverage.write_csv(f'{clean_data_dir}/TX/News/election_cities_with_bond_coverage.csv')
...
# Save city -month level dataset
city_month.write_parquet(f'{clean_data_dir}/TX/City_Month_Elections_News_WithFailed.gzip')
city_month.write_csv(f'{clean_data_dir}/TX/City_Month_Elections_News_WithFailed.csv')

print(f"Saved city-month dataset: {clean_data_dir}/TX/City_Month_Elections_News_WithFailed.*")
...
election_level.write_parquet(f'{clean_data_dir}/TX/News/Election_Level_With_News_WithFailed.gzip')
election_level.write_csv(f'{clean_data_dir}/TX/News/Election_Level_With_News_WithFailed.csv')

print(f"Saved election-level dataset: {clean_data_dir}/TX/News/Election_Level_With_News_WithFailed.*")
...
print(f"  - {clean_data_dir}/TX/News/election_cities_with_bond_coverage.csv")
print(f"  - {clean_data_dir}/TX/City_Month_Elections_News_WithFailed.gzip")
print(f"  - {clean_data_dir}/TX/City_Month_Elections_News_WithFailed.csv")
print(f"  - {clean_data_dir}/TX/News/Election_Level_With_News_WithFailed.gzip")
print(f"  - {clean_data_dir}/TX/News/Election_Level_With_News_WithFailed.csv")
