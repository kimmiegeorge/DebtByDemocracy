...
classification_dir = clean_data_dir / 'DPC Data' / 'News' / 'OpenAI Bond Election Classification'
chunk_dir = classification_dir / 'batch_chunks'
control_dir = clean_data_dir / 'DPC Data' / 'News' / 'Control State Bond Election Articles'

candidate_csv = classification_dir / 'DPC_Bond_Election_Candidate_Articles.csv'
combined_output_jsonl = classification_dir / 'DPC_Bond_Election_OpenAI_Batch_Output_All_Chunks.jsonl'

all_classifications_csv = classification_dir / 'DPC_Bond_Election_OpenAI_Classifications_Processed.csv'
classification_summary_csv = classification_dir / 'DPC_Bond_Election_OpenAI_Classification_Summary.csv'

control_articles_csv = control_dir / 'Control_State_Bond_Election_Articles.csv'
control_ai_joined_csv = classification_dir / 'Control_State_OpenAI_Bond_Election_Classifications.csv'
control_summary_csv = classification_dir / 'Control_State_OpenAI_Bond_Election_Summary.csv'
control_voter_examples_csv = classification_dir / 'Control_State_OpenAI_Voter_Bond_Referendum_Examples.csv'
control_non_education_referendum_csv = (
    classification_dir / 'Control_State_OpenAI_Non_Education_Voter_Bond_Referendum_Articles.csv'
)
...
def get_completed_output_files() -> list[Path]:
    ...
    chunk_outputs = sorted(chunk_dir.glob('DPC_Bond_Election_OpenAI_Batch_Output_part*.jsonl'))
    if chunk_outputs:
...
def save_control_state_non_education_referenda(classified_articles: pl.DataFrame) -> pl.DataFrame:
    ...
    '''
    issuance_dpc = pl.read_parquet(clean_data_dir / 'DPC Data' / 'News' / 'Issuance_Lvl_DPC_News.gzip')
    control_states = (
        issuance_dpc
