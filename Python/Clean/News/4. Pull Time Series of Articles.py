...
os.makedirs(os.path.expanduser(f'{clean_data_dir}/News'), exist_ok=True)
...
rp_cities_with_coverage.write_csv(f'{clean_data_dir}/News/cities_with_bond_related_coverage.csv')
####
...
seed_month.write_parquet(f'{clean_data_dir}/News/Full_City_Month_Data_Headline_Filter.gzip')
...
issuance_months.write_parquet(f'{clean_data_dir}/News/Issuance_Lvl_AbnormalNews_HeadlineFilter.gzip')
...
event_plot_df.write_csv(f'{clean_data_dir}/News/City_Month_DF_For_Event_Plot.csv')
...
event_plot_df.write_csv(f'{clean_data_dir}/News/City_Month_DF_For_Event_Plot_GO_Only.csv')
...
event_plot_df.write_csv(f'{clean_data_dir}/News/City_Month_DF_For_Event_Plot_Unlim_GO_Only.csv')
