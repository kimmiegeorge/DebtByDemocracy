...
Output: Data\Statutes\260624_sourcelevel_expand25.csv  (UTF-8 with BOM)
"""
...
OUT = Path(r"C:\Users\juneh\Dropbox (Personal)\Voting on Bonds"
          r"\Data\Statutes\260624_sourcelevel_expand25.csv")
...
ROWS = [
    ...
    R(stab="CA", state="california",
      ...
      note_textreq="The bond ordinance must recite the object and purpose of the indebtedness, the estimated cost of the improvements, the principal amount of the indebtedness, and the maximum rate of interest (Sec. 43610)",
    ...
    R(stab="FL", state="florida",
      ...
      note_pubnotice="The governing authority gives notice of the bond referendum in the manner prescribed by Fla. Stat. 100.342 (newspaper publication) (Sec. 100.211); general election laws govern the conduct of the referendum (Sec. 100.221)",
      note_exception=NONE,
    ...
    R(stab="OH", state="ohio",
      ...
      note_textreq=NONE,
      note_timing="At a general or special election (procedure under Ohio Rev. Code ch. 133)",
      note_pubnotice=NONE,
      note_exception="The detailed voted/unvoted procedure and the 10-mill limit are in Ohio Rev. Code ch. 133 (Uniform Public Securities Law) and ch. 5705, which lie in Ohio code titles outside the downloaded corpus; this row is grounded in the Ohio Constitution",
    ...
    R(stab="OH", state="ohio",
      ...
      note_textreq=NONE, note_timing=NONE, note_pubnotice=NONE,
      note_exception="These bonds are not 'net indebtedness' of the municipality and are excluded from the debt limit; the foreclosure franchise may not exceed 20 years (Ohio Const. art. XVIII Sec. 12)",
    ...
    R(stab="OK", state="oklahoma",
      ...
      note_textreq=NONE, note_timing=NONE, note_pubnotice=NONE,
      note_exception="No new election is required where the municipality (or a public trust having it as beneficiary) already owned/operated that kind of utility, or where voters approved the acquisition/construction within the prior 10 years (Sec. 11-22-155)",
      note_votereqbyothergovtlevels="Applies to municipalities and their beneficiary public trusts (Sec. 11-22-155)"),
    ...
    R(stab="TX", state="texas",
      ...
      note_textreq=NONE,
      note_timing="At a bond election held under the Election Code (Tex. Gov. Code ch. 1251)",
      note_pubnotice=NONE,
      note_exception="The operative bond-election procedure and majority-vote requirement are in Tex. Gov. Code ch. 1251 (Bond Elections), which is in a Texas code not among the downloaded titles; this row is grounded in the Texas Constitution",
    ...
    R(stab="TX", state="texas",
      ...
      note_textreq=NONE, note_timing=NONE, note_pubnotice=NONE,
      note_exception="Because revenue bonds do not pledge ad valorem taxes, the art. XI Sec. 5 tax/debt limitation and the statutory bond election do not apply; revenue-bond authority appears in the Local Government Code and Government Code (e.g., ch. 1502), portions of which lie outside the downloaded corpus",
