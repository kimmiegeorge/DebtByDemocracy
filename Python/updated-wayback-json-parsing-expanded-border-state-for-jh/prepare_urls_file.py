...
INPUT_FILE = "/Users/kmunevar/Dropbox/Voting on Bonds/Data/Websites/Border States Website Data/Expanded Border Matches Issuers Website Collected 20251008.csv"
OUTPUT_DIR = Path("/Users/kmunevar/Dropbox/Voting on Bonds/Data/Websites/Border States Website Data/Collection Files 20251009/")
BASENAME = "Border_Matches_URLs_20251009"
DEFAULT_CHUNK_SIZE = 120  # roughly matches existing URL_Set sizes
...
def prepare_and_split_urls_file(input_file: str = INPUT_FILE,
    ...
    df_filtered = df[df['City Website'].notna() & (df['City Website'] != 'NA') & (df['City Website'] != '') & (df['prev_collected'] == 0)]
