...
gen maturity_mths = maturity_days / (365/30)
*br seed_issuer year offering_date maturity* amount ln_amount
...
*save file
save "$MERGENT\Clean\250313_citycountyschool_cusiplevel_statereq_purpose.dta", replace
