...
esttab using "$DESCRIPT\Bondlevel\250313_bondlevel_sumstats_city_v2.tex", replace ///
...
esttab using "$RESULTS/250313_city_yield_UTGO_vF.tex", replace t noconstant b(3) ///
