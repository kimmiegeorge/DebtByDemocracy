...
*Merge in
mmerge purposedescription using "$TX\2025-03-09_texasbondpurpose_classify.dta", type(n:1) missing(nomatch)
*all matched
drop _merge
...
-------------+-----------------------------------
     ...
     econdev |         20        1.18        8.99
        educ |          3        0.18        9.17
       envir |         21        1.23       10.40
genpubimprov |         37        2.17       12.57
      health |         31        1.82       14.39
     housing |         11        0.65       15.04
     justice |         70        4.11       19.15
       other |         75        4.41       23.56
    parksrec |        374       21.97       45.53
     pension |          2        0.12       45.65
     pubbldg |        109        6.40       52.06
      safety |        244       14.34       66.39
      street |          1        0.06       66.45
   transport |        493       28.97       95.42
...
replace purp_broad = "transport" if purp_broad == "street"
*later, check street and transport

local temp arts econdev educ envir genpubimprov health housing justice other parksrec pubbldg safety transport utilities wtrswr
...
local temp genpubimprov pubbldg transport health arts parksrec envir econdev housing safety justice utilities wtrswr other
foreach x of local temp{
	sum votemargin if purp_broad == "`x'" & passed == 1 & votemargin != 1, d
	sum votemargin if purp_broad == "`x'" & passed == 0 & votemargin != 1, d
}
/*Notes
- genpubimprov: passed: med = 0.261, mean = 0.274; failed: med=0.070, mean=0.157
- pubbldg: passed: med = 0.234, mean = 0.262; failed: med=0.190, mean=0.248
- transport: passed: med = 0.408, mean = 0.410; failed: med=0.137, mean=0.210
- health: med = 0.366, mean = 0.350; failed: med=0.334, mean=0.334
- arts: med = 0.315, mean = 0.333; failed: med=0.130, mean=0.155 
- parksrec: med = 0.271, mean = 0.281; failed: med=0.181, mean=0.203 
- envir: med = 0.438, mean = 0.451; failed: med=0.117, mean=0.161 
- econdev: med = 0.367, mean = 0.297; failed: med=0.146, mean=0.150 
- housing: med = 0.235, mean = .289; failed: med=0.022, mean=0.022
- safety:med = 0.424, mean = 0.418; failed: med=0.091, mean=0.141
- justice: med = 0.179, mean = 0.200; failed: med=0.125, mean=0.200 
- utilities: med = 0.503, mean = 0.514; no failures
- wtrswr: med = 0.486, mean = 0.461; failed: med=0.087, med=0.136 
- other: med = 0.343, mean = 0.347; failed: med=0.074, med=0.140
*/

local temp genpubimprov pubbldg transport health arts parksrec envir econdev housing safety justice utilities wtrswr other
foreach x of local temp{
	sum passed if purp_broad == "`x'" 
}
