...
- Add yield spread to issuer-level data and bond-level data
*/
...
*Add yield spreads to this data*
...
mmerge issue_id cusip using "$MERGENT\Clean\250701_bond_level_off_yield_spread.dta", ///
...
*unmatched ones have weird payment structures

drop _merge

*save
save "$MERGENT\Clean\250707_city_cusiplevel_statereq_purpose_yieldspread.dta", replace
...
*save file
save "$MERGENT\Clean\250701_issuers_yieldspread.dta", replace

*Add this to main issuer-level file
use "$MERGENT\Clean\250625_city_issuerlevel.dta", clear
mmerge seed_issuer using "$MERGENT\Clean\250701_issuers_yieldspread.dta", ///
	type(n:1) missing(nomatch)
*all matched, hooray
drop _merge
sort state seed_issuer
...
*save file
save "$MERGENT\Clean\250701_city_issuerlevel_yieldspread.dta", replace