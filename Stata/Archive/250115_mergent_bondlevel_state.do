...
import delimited "$DATA\Bond Elections\250115_election_requirements_by_state.csv", clear
*save
save "$DATA\Bond Elections\250115_election_requirements_by_state.dta", replace
...
*merge in state laws
mmerge state using "$DATA\Bond Elections\250115_election_requirements_by_state.dta", ///
...
*save file
save "$MERGENT\Clean\250115_citycountyschool_cusiplevel_statereq.dta", replace
