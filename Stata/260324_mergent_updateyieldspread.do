...
*save file
save "$MERGENT\Clean\260324_issuers_yieldspread.dta", replace
...
mmerge seed_issuer using "$MERGENT\Clean\260324_issuers_yieldspread.dta", ///
	type(n:1) missing(nomatch)
drop _merge
sort state seed_issuer 

*save
save "$MERGENT\Clean\260324_city_issuerlevel_yieldspread.dta", replace
